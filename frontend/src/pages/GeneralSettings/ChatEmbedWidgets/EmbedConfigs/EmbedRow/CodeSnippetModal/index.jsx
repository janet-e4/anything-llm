...
https://github.com/janet-e4/anything-llm/blob/e4/ui-customizations/UPGRADING.md
-->
<script
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/janet-e4/anything-llm/blob/e4/ui-customizations/UPGRADING.md"
          target="_blank"
          rel="noreferrer"
